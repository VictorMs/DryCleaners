 ...
 * 
 * @usage      require_once 'MobileDetect.php';
        ...
        if (
           ...
           (isset($_SERVER['HTTP_UA_CPU']) && $_SERVER['HTTP_UA_CPU'] == 'ARM') // Seen this on a HTC
                ...
                $this->isMobile = true;
        		   ...
        		   (strpos($this->accept, 'text/vnd.wap.wml') !== false || strpos($this->accept, 'application/vnd.wap.xhtml+xml') !== false)) {
                $this->isMobile = true;
        } else {
                $this->_detect();
        }        
    ...
    */
    ...
    public function isTablet()
    {
        ...
        foreach($this->tabletDevices as $_key => $_regex){
            if(preg_match('/'.$_regex.'/is', $this->userAgent)){
                $this->isTablet = true;
                $this->tabletDevicename = $this->userAgent;
                return true;
            }
        }
